function generateAppearanceHalfOrc(gender) {
	let appearance = {};
	...
	switch (appearance.randomSkinColor) {
		case 'Blass':
			appearance.skinColorHex = getRandomElement([...skinColorPaleOrc, ...skinColorPale]);
			break;
		case 'Weiß':
			appearance.skinColorHex = getRandomElement([...skinColorWhiteOrc, ...skinColorWhite]);
			break;
		case 'Hellbraun':
			...
			break;
		case 'Braun':
			appearance.skinColorHex = getRandomElement([...skinColorBrownOrc, ...skinColorBrown]);
			break;
		case 'Dunkelbraun':
			appearance.skinColorHex = getRandomElement([
			...
			break;
		case 'Schwarz':
			appearance.skinColorHex = getRandomElement([...skinColorBlackOrc, ...skinColorBlack]);
			break;
		default:
