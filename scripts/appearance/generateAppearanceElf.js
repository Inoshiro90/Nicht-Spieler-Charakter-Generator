function generateAppearanceElf(gender) {
	let appearance = {};
	...
	switch (appearance.randomSkinColor) {
		case 'Blass':
			appearance.skinColorHex = getRandomElement([...skinColorPaleElf, ...skinColorPale]);
			break;
		case 'Weiß':
			appearance.skinColorHex = getRandomElement([...skinColorWhiteElf, ...skinColorWhite]);
			break;
		case 'Hellbraun':
			...
			break;
		case 'Braun':
			appearance.skinColorHex = getRandomElement([...skinColorBrownElf, ...skinColorBrown]);
			break;
		case 'Dunkelbraun':
			appearance.skinColorHex = getRandomElement([
			...
			break;
		case 'Schwarz':
			appearance.skinColorHex = getRandomElement([...skinColorBlackElf, ...skinColorBlack]);
			break;
		default:
